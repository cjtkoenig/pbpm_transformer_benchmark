"""
This file contains the MTLFormer model.
It is based on the implementation in the following repository with only minor modifications:
https://github.com/jiaojiaowang1992/MTLFormer/blob/main/code/MULTI%20TASK/processtransformer/models/transformer.py
"""
